...
using OpenMeteoApiNet.DataFrames.HourlyData.IFS_HRES;
    ...
    public static class ifsHRESHourlyForecastApi
    {
...

        {
            ...
            if (data != null)
            {
                ...
                var df = ifsHRESDataFrame.ToDataFrame(data);
                ...
                if (toCsv == true)
                {
                    ...
                    if (fileName == null)
                    {
                        ...
                        fileName = $"IFS_HRES_PointForecast_{latString}_{lonString}.csv";
                    }
                    else
                    {
                        fileName = fileName;
