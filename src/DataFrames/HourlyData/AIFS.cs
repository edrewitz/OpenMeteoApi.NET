...
using OpenMeteoApiNet.Variables.HourlyData.AIFS;

namespace OpenMeteoApiNet.DataFrames.HourlyData.AIFS
{
    public class aifsDataFrame
    {
        public static DataFrame ToDataFrame(aifsParams data)
        {
            /*
             * Converts the data object of type aifsParams to a DataFrame object.
             * 
             * Returns
             * -------
             * 
