...
using OpenMeteoApiNet.Variables.HourlyData.IFS_HRES;

namespace OpenMeteoApiNet.DataFrames.HourlyData.IFS_HRES
{
    public class ifsHRESDataFrame
    {
        public static DataFrame ToDataFrame(ifsHRESParams data)
        {
            /*
             ...
             * -------
             * 
             * Microsoft.Data.Analysis.DataFrame object containing the data from the ifsHRESParams object.
             * 
             */
