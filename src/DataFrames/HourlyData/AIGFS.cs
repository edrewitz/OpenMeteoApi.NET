...
using OpenMeteoApiNet.Variables.HourlyData.AIGFS;

namespace OpenMeteoApiNet.DataFrames.HourlyData.AIGFS
{
    public class aigfsDataFrame
    {
        public static DataFrame ToDataFrame(aigfsParams data)
        {
            /*
