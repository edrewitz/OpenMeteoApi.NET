...
namespace OpenMeteoApiNet.EnsembleForecasts.DWD.ICON_EPS
{
    public static class ifsENSHourlyForecastApi
    {
        ...
        private static DataFrame ToDataFrame(ifsENSParams data)
        {
            /*
             * Converts the data object of type ifsENSParams to a DataFrame object.
             * 
             * Returns
             * -------
             * 
             * Microsoft.Data.Analysis.DataFrame object containing the data from the ifsENSParams object.
             * 
             */
