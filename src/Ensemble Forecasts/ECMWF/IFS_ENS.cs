...
using OpenMeteoApiNet.DataFrames.HourlyData.IFS_ENS;
using OpenMeteoApiNet.Variables.HourlyData.IFS_ENS;
...
{
    public static class ifsENSHourlyForecastApi
    {
...

        {
            ...
            string url = $"https://ensemble-api.open-meteo.com/v1/ensemble?latitude={latitude}&longitude={longitude}" +
                $"&hourly={modelParams}" +
                $"&models=ecmwf_ifs025_ensemble&forecast_days={days}" +
            ...
            // Deserialize the "hourly" property into our ifsENSParams class. If deserialization fails, print an error message and return.
            var data = JsonSerializer.Deserialize<ifsENSParams>(hourlyWeatherElement.GetRawText());
            ...
            if (data != null)
            {
                ...
                var df = ifsENSDataFrame.ToDataFrame(data);
                ...
                if (toCsv == true)
                {
                    ...
                    if (fileName == null)
                    {
                        ...
                        fileName = $"ECMWF_IFS_ENS_PointForecast_{latString}_{lonString}.csv";
                    }
                    else
                    {
                        fileName = fileName;
            ...
            {
                Console.WriteLine($"ECMWF IFS ENS Data Not Available At This Time");
                return null;
