...
using OpenMeteoApiNet.DataFrames.HourlyData.AIGEFS;
...
namespace OpenMeteoApiNet.EnsembleForecasts.NOAA.AIGEFS
{
    ...
    public static class aigefsHourlyForecastApi
    {
        ...
        /*
         * This function is the client that retrieves and returns the hourly NOAA/NCEP/AIGEFS ensemble point forecast for a specified point of lat/lon.
         * 
         * Required Arguments:
         * 
...

        {
            ...
            if (data != null)
            {
                ...
                var df = aigefsDataFrame.ToDataFrame(data);
